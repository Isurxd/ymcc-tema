          ...
          <div className="flex-grow bg-white border-2 border-black rounded-[2rem] p-6 md:p-10 shadow-brutal w-full hover:-translate-y-2 hover:shadow-[8px_8px_0px_0px_rgba(17,17,17,1)] transition-all duration-300">
            ...
            <div className="space-y-6 mb-10">
              <div className="flex items-center gap-4">
                ...
                <span className="font-poppins text-lg md:text-xl text-[#111]">0858 1722 2427</span>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-[#c1ff00] border-2 border-black rounded-full flex items-center justify-center flex-shrink-0">
            ...
            <div className="flex flex-wrap gap-4">
              <a href="https://wa.me/6285817222427" target="_blank" rel="noopener noreferrer" className="bg-[#c1ff00] border-2 border-black rounded-full px-6 py-3 font-poppins font-bold text-sm text-[#111] hover:bg-black hover:text-white transition-colors flex items-center gap-2">
